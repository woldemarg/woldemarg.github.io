...
function redrawFirstPart() {
    ...
    function mousemove() {
        ...
        if (leftEdges[i] !== undefined) {
            ...
            d3.selectAll(".col-" + country)
                .style('fill', "#FAA61A");//цвет выделения столбика
    ...
    function mouseout() {
        ...
        d3.selectAll("#bar")
            .style('fill', "#FEC779");//возвращаем исходный цвет
        d3.selectAll("#label")
            .classed("hidden", true);
        d3.selectAll('#caption')
            .style('display', 'none')
...
function addFrance() {
    ...
    datasetFirstPart.push ({year:"2008", country:"Франція", abbr:"Ф", eu: "old", order: "18", val: "10.2", avg: "9.4"})
    datasetFirstPart.push ({year:"2010", country:"Франція", abbr:"Ф", eu: "old", order: "18", val: "11", avg: "10"})
    datasetFirstPart.push ({year:"2012", country:"Франція", abbr:"Ф", eu: "old", order: "18", val: "10.9", avg: "10.1"})
    datasetFirstPart.push ({year:"2014", country:"Франція", abbr:"Ф", eu: "old", order: "18", val: "11.3", avg: "10.2"})
...
function addFinland() {
    ...
    datasetFirstPart.push ({year:"2008", country:"Фінляндія", abbr:"Фі", eu: "old", order: "17", val: "15.6", avg: "9.4"})
    datasetFirstPart.push ({year:"2010", country:"Фінляндія", abbr:"Фі", eu: "old", order: "17", val: "16.9", avg: "10"})
    datasetFirstPart.push ({year:"2012", country:"Фінляндія", abbr:"Фі", eu: "old", order: "17", val: "18.4", avg: "10.1"})
    datasetFirstPart.push ({year:"2014", country:"Фінляндія", abbr:"Фі", eu: "old", order: "17", val: "19.7", avg: "10.2"})
...
function addSweden() {
    ...
    datasetFirstPart.push ({year:"2008", country:"Швеція", abbr:"Ш", eu: "old", order: "20", val: "19.5", avg: "9.4"})
   datasetFirstPart.push ({year:"2010", country:"Швеція", abbr:"Ш", eu: "old", order: "20", val: "20.8", avg: "10"})
   datasetFirstPart.push ({year:"2012", country:"Швеція", abbr:"Ш", eu: "old", order: "20", val: "24", avg: "10.1"})
   datasetFirstPart.push ({year:"2014", country:"Швеція", abbr:"Ш", eu: "old", order: "20", val: "25", avg: "10.2"})
...
function addBulgaria() {
    ...
    datasetFirstPart.push ({year:"2008", country:"Болгарія", abbr:"Б", eu: "new", order: "2", val: "1.6", avg: "9.4"})
   datasetFirstPart.push ({year:"2010", country:"Болгарія", abbr:"Б", eu: "new", order: "2", val: "1.7", avg: "10"})
   datasetFirstPart.push ({year:"2012", country:"Болгарія", abbr:"Б", eu: "new", order: "2", val: "1.8", avg: "10.1"})
   datasetFirstPart.push ({year:"2014", country:"Болгарія", abbr:"Б", eu: "new", order: "2", val: "2.3", avg: "10.2"})
...
function addLithuania() {
    ...
    datasetFirstPart.push ({year:"2008", country:"Литва", abbr:"Л", eu: "new", order: "9", val: "3.7", avg: "9.4"})
   datasetFirstPart.push ({year:"2010", country:"Литва", abbr:"Л", eu: "new", order: "9", val: "3.5", avg: "10"})
   datasetFirstPart.push ({year:"2012", country:"Литва", abbr:"Л", eu: "new", order: "9", val: "3.6", avg: "10.1"})
   datasetFirstPart.push ({year:"2014", country:"Литва", abbr:"Л", eu: "new", order: "9", val: "3.8", avg: "10.2"})
...
function addRomania() {
    ...
    datasetFirstPart.push ({year:"2008", country:"Румунія", abbr:"Р", eu: "new", order: "13", val: "2.6", avg: "9.4"})
   datasetFirstPart.push ({year:"2010", country:"Румунія", abbr:"Р", eu: "new", order: "13", val: "2.4", avg: "10"})
   datasetFirstPart.push ({year:"2012", country:"Румунія", abbr:"Р", eu: "new", order: "13", val: "2.3", avg: "10.1"})
   datasetFirstPart.push ({year:"2014", country:"Румунія", abbr:"Р", eu: "new", order: "13", val: "2.6", avg: "10.2"})
